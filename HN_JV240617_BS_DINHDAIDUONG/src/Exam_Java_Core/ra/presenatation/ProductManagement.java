...
import Exam_Java_Core.ra.business.design.features.IProductFeatures;
...
public class ProductManagement {
    IProductFeatures producFeature = new ProductFeatureImpl();
    public void menuProduct(Scanner sc) {
        ...
        do
        {
            ...
            switch (choice)
            {
                ...
                default:
                    System.err.println("Nhập lại từ 1 -> 7 đê");
            }
        }
        while (isLoop);
    }
    ...
    private void updateProduct(Scanner sc) {
        ...
        System.out.println("Mời bạn nhâp idUpdate");
